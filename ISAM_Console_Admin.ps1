...
$HTMLPage += html -Class "fontawesome-i2svg-active fontawesome-i2svg-complete" -Attributes @{"lang"="pt-br" } {
    ...
    body -Class "nav-fixed" -Attributes @{ "cz-shortcut-listen"="true" } { 
        ...
        nav -Class "topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-dark bg-dark" -id "sidenavAccordion" {
            ...
            button -Class "btn btn-icon btn-transparent-dark order-1 order-lg-0 me-2 ms-lg-2 me-lg-0" -Id "sidebarToggle" { i -Class "material-icons text-light text-gray-500" "menu" } #-Attributes @{"data-feather"="menu"}
            # Navbar Brand
            ...
            Form -action "#" -Class "form-inline me-auto d-none d-lg-block me-3" -method post -Content {
                Div -Class "input-group input-group-joined input-group-solid" {
                    input -Class "form-control pe-0" -name "NavbarSearch" -type "search" -Attributes @{ "placeholder"="Procurar";"aria-label"="Search" }
                      Div -Class "input-group-text" { i -Class "material-icons text-light text-gray-500" "search" } #-Attributes @{"data-feather"="search"}
                }
            ...
            ul -Class "navbar-nav align-items-center ms-auto" {
                ...
                li -Class "nav-item dropdown no-caret me-3 d-lg-none" {
                    a -Class "btn btn-light btn-icon btn-transparent-dark dropdown-toggle" -Id "searchDropdown" -href "#" -Attributes @{ "role"="button";"data-bs-toggle"="dropdown";"aria-haspopup"="true";"aria-expanded"="false" } { i -Attributes @{"data-feather"="search"} } 
                ...
                li -Class "nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications" {
                      a -Class "btn btn-icon btn-transparent-dark dropdown-toggle mdc-ripple-upgraded" -Id "navbarDropdownAlerts" -href "javascript:void(0);" -Attributes @{ "role"="button";"data-bs-toggle"="dropdown";"aria-haspopup"="true";"aria-expanded"="false" }  { i -Class "material-icons text-light text-gray-500" "notifications" }  #  { i -Attributes @{"data-feather"="bell"} }
                ...
                li -Class "nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications" {
                      a -Class "btn btn-icon btn-transparent-dark dropdown-toggle" -id "navbarDropdownMessages" -href "javascript:void(0);" -Attributes @{ "role"="button";"data-bs-toggle"="dropdown";"aria-haspopup"="true";"aria-expanded"="false" } { i -Class "material-icons text-light text-gray-500" "mail_outline" } #-Attributes @{"data-feather"="mail"} 
                ...
                nav -Class "sidenav shadow-right sidenav-light" {
                    ...
                    Div -Class "sidenav-footer" {
                       Div -Class "sidenav-footer-content" {
                          ...
                          Div -Class "sidenav-footer-title" { "Al" }
                       }
                    }
